  ...
  var Accordion = function Accordion(selector, userOptions) {
    var ac = {
      ...
      toggleElement: function toggleElement(element) {
        ...
        element.classList.toggle('active'); // Open element without animation
...
(function () {
  ...
  var inputChangeState = function (e) {
    if (agreementCtrl.checked) {
      makeChecked(); //console.log('Checked');
    } else {
      makeUnChecked(); //console.log('UnChecked');
    }
  };
...
(function () {
  ...
  var callBackBtnHandler = function (e) {
    e.preventDefault(); //console.log('Нажали на кнопку: ' + e.target.classList);
