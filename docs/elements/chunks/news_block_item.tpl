<article class="news-block__item  swiper-slide">
  ...
  <a class="news-block__img-wrapper" href="[[+uri]]">
    <picture>
      <source srcset="[[+tv.news_img_thumb:phpthumbon=`w=387&h=216&q=85`]]" media="(min-width: 1280px)">
      <source srcset="[[+tv.news_img_thumb:phpthumbon=`w=480&h=268&q=80`]]" media="(min-width: 768px)">
  ...
  <div class="news-block__content">
    ...
    <span class="news-block__date">[[+publishedon:date=`%d.%m.%Y`]]</span>
  </div>
